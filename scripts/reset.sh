...
echo "    trip) — run ./scripts/sync-github.sh to repopulate it, or use"
echo "    ./scripts/demo.sh instead of this script to do both plus a"
echo "    readiness check in one go."
